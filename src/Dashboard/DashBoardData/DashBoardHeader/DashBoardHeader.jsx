  ...
  return (
    <>
      <div className="flex  justify-between items-center gap-5 border-b border-[#F3F5F7] py-[18px] px-8 bg-white">
        <button
          className="block sm:hidden text-[#596780] cursor-pointer"
          onClick={() => {
            setIsOpen((prev) => !prev);
          }}
        >
        ...
        <div className="grow-0 shrink-0 basis-1/2 flex justify-end items-center gap-[32px]">
          <div
            ...
            className="group border border-[#F3F5F7] min-w-[44px] min-h-[44px] rounded-full flex justify-center items-center cursor-pointer relative"
          >
